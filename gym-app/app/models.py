...
class Cliente(db.Model):
    ...
    estado_laboral = Column(String(40))   # Ej: Dependiente, Independiente, Cesante
...
class FaceTemplate(db.Model):
    ...
    face_template_id = db.Column(db.Integer, primary_key=True)
    cliente_id = db.Column(
        db.Integer,
        db.ForeignKey("clientes.cliente_id", ondelete="CASCADE"),
        nullable=False
    )

    model_name = db.Column(db.String(50), nullable=False, default="insightface")
    ...
    created_at = db.Column(db.DateTime, default=ahora_chile)